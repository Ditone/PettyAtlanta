...
@Entity(name = "august_temp")
@JsonIgnoreProperties({"hibernateLazyInitializer", "handler"})
public class WeatherAug{
    @Id
    ...
    public WeatherAug(Integer cityId, String city, Integer highDegF, Integer lowDegF, Integer highDegC, Integer lowDegC) {
        this.city = city;
